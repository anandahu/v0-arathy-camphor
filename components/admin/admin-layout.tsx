...
import { Package, BarChart3, Users, FileText, Home, Menu, Bell, Search, ShoppingCart, Tag, LogOut } from "lucide-react"
      ...
      <div className="p-6 border-b border-maroon-200">
        <Link href="/" className="flex items-center space-x-3">
          ...
          <div>
            ...
            <p className="text-xs text-maroon-600">Management Panel</p>
          </div>
        </Link>
      </div>
          ...
          return (
            <Link
              ...
              className={`flex items-center space-x-3 px-3 py-2 rounded-lg transition-colors ${
                isCurrent
                  ? "bg-maroon-100 text-maroon-900 border-l-4 border-maroon-600"
            ...
            <div className="flex items-center justify-between">
              <div className="flex items-center space-x-4">
                ...
                <div className="relative hidden sm:block">
                  ...
                  <Input placeholder="Search..." className="pl-10 w-64 border-maroon-200 focus:border-maroon-400" />
                </div>
              </div>
